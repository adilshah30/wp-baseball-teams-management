<?php
/*
* Plugin Name: KC Sox Baseball Teams Management
* Version: 1.0.0
* Description: This is a Baseball teams management plugin, for managing Coaches, coaches teams/classes, players, Event management,calendar,gallaries , downloads, pdfs, report cards, report cards (pdfs generations), built in custom shopping cart, user (coahes/assistant coaches/players/teams) register/Invites via email, messaging, bootstrap , responsive for mobile devices. For Plugin's Documentation click <a href="http://adilshah.com" target="_blank">here</a>
* Author: Adil Shah
*/
session_start();
