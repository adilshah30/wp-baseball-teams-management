...
<div class="mc-content-wrap">
     <div class="h_wrapper">
	    <div class="body home-left">
                <div class="page-section-wrap mr-b5">
                    <h2 class="page-section-title"><?php echo $day_word." ".$day.", ".$year ; ?></h2>
                </div>
...
//                                        $query = "SELECT * FROM $table_art_gallery WHERE `teacher_id` = '".$TEACHER_ID."'  order by id desc limit 1";
                ...
                <div class="lower_menu1">
                        <div class="page-section-wrap mr-b5">
                            <h2 class="page-section-title"><i class="fa fa-list-alt" aria-hidden="true"></i> Birthdays</h2>
                        </div>
	    	...
	    	<div class="lower_menu2">
                    <div class="page-section-wrap mr-b5">
                            <h2 class="page-section-title"><i class="fa fa-book" aria-hidden="true"></i> Homework</h2>
                    </div>
                    ...
                    <div class="section_li" >
						...
						$arr = explode(".", $item->homework_title, 2);
                            ...
                            <li style=""><i class="fa fa-angle-double-right" aria-hidden="true"></i><span style="font-size:12px;"><span class="homework-list-text">&nbsp;<?= $item->subject_name; ?> </span>- <?= " ".ucfirst($arr[0]); ?></span></li>
						<?php } ?>
	    	...
	    	<div class="lower_menu3">
                        ...
                        <div class="page-section-wrap mr-b5">
                                <h2 class="page-section-title"><i class="fa fa-file" aria-hidden="true"></i> Newsletter</h2>
                        </div>
		    	<div class="menu_body">					
                                <?php
            ...
            <div class="lower_menu4">
                ...
                <div class="page-section-wrap mr-b5">
                    <h2 class="page-section-title">Gallery</h2>
                </div>
...
<!--                <div class="t_gallery">
	    	...
	    	<div class="stu_of_week">
                    <div class="page-section-wrap mr-b5">
                                <h2 class="page-section-title"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Student of the Week</h2>
                    </div>
